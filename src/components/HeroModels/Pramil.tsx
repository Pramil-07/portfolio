              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <a href="https://github.com/Pramil-07" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center hover:bg-white/20 transition-colors cursor-pointer ring-1 ring-white/10">
                    ...
                    <a href="https://www.linkedin.com/in/pramil-dhungana/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center hover:bg-white/20 transition-colors cursor-pointer ring-1 ring-white/10">
                      <svg className="w-4 h-4 text-foreground" fill="currentColor" viewBox="0 0 24 24">
